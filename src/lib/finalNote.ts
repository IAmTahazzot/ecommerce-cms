...
export const note: {} = {
  ...
  date: 'March 8, 2024',
  message:
    "📃 >>> If you happened to find out about this in any way, you may find yourself in an unwelcome scenario. I'm only saying this since I'll be taking my own life on a coming new year, very soon perhaps (not more than 2 years from today). To be honest, I sometimes write silly things anywhere to give the impression that I'm writing to someone, but sadly, she doesn't even know. Because it won't matter to her (I can't blame that, everyone has their own choice). [Even though I've lot more reason than that, I can't end it before it because I got some responsibility over my emotion, and you're right, family. Just before I go, I had to assist them a little otherwise I'll be nothing but a waste to them.",
  feeling: "f**k life",
  advice:
    "🎁 I hope the best for your future and forget it as if nothing happened.",
  fromMe:
  ...
  last_advice:
    "⚠️ If you are not interested in learning more about me, DO NOT CLICK THE LINK AS IT WILL WASTE YOUR TIME.",
  signature: "Tahazzot",
};
