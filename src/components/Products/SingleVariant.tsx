...
export const Variant = ({
  ...
  if (editing) {
    return (
      <div className="p-4 rounded-xl" aria-label="variant">
            ...
            >
              ...
              <SelectContent>
                {Object.keys(variants).map((variantType, index) => (
                  <SelectItem key={index} value={variantType}>
          ...
          <Button
            ...
            onClick={() => {
              if (selectedVariantType) {
                onDelete(id, selectedVariantType);
              } else {
                onDelete(id);
              }
            }}
...
// create a new empty option after current one if it's not empty
                                if (
            ...
            <div className="grid grid-cols-[40px_1fr_40px] gap-2 mt-4">
              <Button
                ...
                onClick={() => {
                  ...
                  setSelectedVariantValues(newValues);
                  updateVariants(selectedVariantType, newValues);
                  setEditing(false);
                }}
              >
                Done
